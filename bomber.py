...
def do_zip_update():
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/IncredibleHacker/TBomb-2.0")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/IncredibleHacker/TBomb-2.0 HEAD")
    sys.exit()
...
__CONTRIBUTORS__ = [ 'Incredible Hacker','Nitro', 'SpeedX', 't0xic0der', 'scpketer', 'Stefan']
